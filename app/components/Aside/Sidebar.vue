...
<template>
  ...
  >
    ...
    >
      ...
      <ul class="w-full flex flex-col items-center justify-start gap-1 mt-10">
        <li class="w-full flex items-start justify-start cursor-pointer">
          <div
          ...
          >
            ...
            <Transition name="sidebar-link-menu-hover">
              <div
                v-if="activeDashboardLinkMenu && !mainStore.asideFullWidth"
                @click.stop
              ...
              >
                ...
                >
                  <IconBarChartSquare02 class="link-active-icon w-[25px]" />
        ...
        >
          ...
          >
            <div class="h-[40px] flex items-center justify-between gap-3">
              <component
                :is="item.icon"
                class="link-active-icon w-[25px]"
              ...
              <Transition name="link-text">
                ...
                >
                  ...
                  <IconChevronUp
                    :class="[
                      {
                        'text-c-primary-500 rotate-[180deg]': item.isActive,
                      },
                    ]"
                  />
                </div>
            ...
            <Transition name="sidebar-link-menu-full">
              <div
                ...
                @click.stop
                class="w-full flex flex-col items-start justify-center mr-2 px-2 gap transition duration-300"
              >
                <template v-for="child in item.child" :key="child.id">
                  ...
                  >
                    <component :is="child.icon" class="link-active-icon" />
                    <span class="link-active-text ml-3 text-16-med">
                      {{ child.title }}
                    </span>
                  </nuxtLink>
